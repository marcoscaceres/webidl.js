define(['WebIDLParser'], function(parser) {
    'use strict';
    var interfaceObject = exportInterfaceObject(WebIDL, 'WebIDL');
    ...
    //parser currently does nothing, apart from parsing
    function parse(someIDL) {
        return parser.parse(someIDL);
    }
    ...
    implementOperation(interfaceObject, 'parse', parse);
